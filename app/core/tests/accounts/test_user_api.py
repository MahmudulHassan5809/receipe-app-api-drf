...
TOKEN_URL = reverse('accounts:create_token')
...
class PublicUserApiTests(TestCase):
    ...
    def test_password_to_short(self):
        """Test password must be more than five character"""
        payload = {
            'email' : 'test@email.com',
            'password' : '1234',
            'name' : 'Test Name'
    ...
    def test_create_token_missing_field(self):
        """Test that email & password are required for token"""
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_not_allowed(self):
        """Test that post request is not allowed in ME_URL"""
