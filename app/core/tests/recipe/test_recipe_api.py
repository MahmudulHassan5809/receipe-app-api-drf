...
def image_upload_url(recipe_id):
    """Return uploaded recipe image url """
...
class RecipeImageUploadTests(TestCase):
    ...
    def setUp(self):
        ...
        def test_upload_image_to_recipe(test):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user = self.user , title = "Thai vegetable curry 2")

        tag1 = sample_tag(user = self.user , name = "Vegan")
        tag2 = sample_tag(user = self.user , name = "Vegan2")
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user = self.user , title = "Thai vegetable curry")
        recipe2 = sample_recipe(user = self.user , title = "Thai vegetable curry 2")
        recipe3 = sample_recipe(user = self.user , title = "Thai vegetable curry 3")

        ingredient1 = sample_ingredient(user = self.user , name = "Vegan")
        ingredient2 = sample_ingredient(user = self.user , name = "Vegan2")
